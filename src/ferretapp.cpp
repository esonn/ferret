...
FerretApp::FerretApp ()
{
	...
	_extract_folder = wxFileName::GetCwd () + wxFILE_SEP_PATH + "FerretAppTempFolder";
...
void FerretApp::ShowUniquenessHelp ()
{
...
wxString FerretApp::GetGeneratedByString ()
{
	return "Generated by " +
		GetVersionString () +
		", (c) School of Computer Science, University of Hertfordshire, 2013.";
}
