...
"More information about Ferret can be found at http://peterlane.info/ferret.html.  For information about the Plagiarism Detection Group see: http://homepages.stca.herts.ac.uk/~pdgroup.\n\n"
...
"Ferret will treat files ending in .doc, .docx or .rtf as word/rtf files, and use 'abiword' to convert them to text.  Files ending in .pdf will be converted using 'pdftotext'.  Files ending in .txt will be treated as plain text files, and not converted.  Files for C/C++, Java, Ruby, Python, Lisp/Scheme/Clojure, HTML/XML are parsed specially.\n\n");
